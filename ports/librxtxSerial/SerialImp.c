...
RXTXPort.Initialize
   ...
   comments:    Basically this just causes rxtx to ignore signals.  signal
		...
		is enabled.
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_Initialize(JNIEnv *env, jclass jclazz)
{
...
RXTXPort.open
   ...
   comments:    Very often people complain about not being able to get past
                ...
                device file or bios has the device disabled.
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_open(JNIEnv *env, jobject jobj, jstring jstr)
{
	int fd;
	int  pid = -1;
	char message[80];
...
RXTXPort.nativeClose
   ...
   exceptions:  none
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_nativeClose( JNIEnv *env, jobject jobj,jstring jstr )
{
	int result, pid;
...
/*----------------------------------------------------------
 RXTXPort.nativeSetSerialPortParams
   ...
   exceptions: UnsupportedCommOperationException
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeSetSerialPortParams( JNIEnv *env, jobject jobj, jint speed, jint dataBits, jint stopBits, jint parity )
{
	int fd = get_java_var( env, jobj,"fd","I" );
...
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_nativeGetFlowControlMode(JNIEnv *env, jobject jobj, jint fd)
{
	struct termios ttyset;
	int ret = 0;
...
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_writeByte( JNIEnv *env, jobject jobj, jint ji, jboolean interrupted )
{
...
RXTXPort.writeArray
   ...
   exceptions:  IOException
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_writeArray(JNIEnv *env, jobject jobj, jbyteArray jbarray, jint offset, jint count, jboolean interrupted )
{
#ifndef TIOCSERGETLSR
	struct event_info_struct *index = master_index;
#endif /* TIOCSERGETLSR */
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeDrain( JNIEnv *env, jobject jobj, jboolean interrupted )
{
	int fd = get_java_var( env, jobj,"fd","I" );
...
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_sendBreak(JNIEnv *env, jobject jobj, jint duration)
{
	int fd = get_java_var( env, jobj,"fd","I" );
	report_time_start( );
...
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_NativegetReceiveTimeout(JNIEnv *env, jobject jobj)
{
	int fd = get_java_var( env, jobj,"fd","I" );
	struct termios ttyset;
...
RXTXPort.NativeisReceiveTimeoutEnabled
   ...
   comments:   see  NativeEnableReceiveTimeoutThreshold
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_NativeisReceiveTimeoutEnabled(JNIEnv *env, jobject jobj)
{
	int fd = get_java_var( env, jobj,"fd","I" );
	struct termios ttyset;
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_isDSR(JNIEnv *env, jobject jobj)
{
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_isCD(JNIEnv *env, jobject jobj)
{
	unsigned int result = 0;
	int fd = get_java_var( env, jobj,"fd","I" );
	char message[80];
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_isCTS(JNIEnv *env, jobject jobj)
{
	unsigned int result = 0;
	int fd = get_java_var( env, jobj,"fd","I" );
	char message[80];
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_isRI(JNIEnv *env, jobject jobj)
{
	unsigned int result = 0;
	int fd = get_java_var( env, jobj,"fd","I" );
	char message[80];
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_isRTS(JNIEnv *env, jobject jobj)
{
	unsigned int result = 0;
	int fd = get_java_var( env, jobj,"fd","I" );
	char message[80];
...
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_setRTS(JNIEnv *env, jobject jobj, jboolean state)
{
	unsigned int result = 0;
	int fd = get_java_var( env, jobj,"fd","I" );
	char message[80];
...
RXTXPort.setDSR
   ...
   comments:    tcsetattr with c_cflag CRTS_IFLOW
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_setDSR(JNIEnv *env, jobject jobj, jboolean state)
{
	unsigned int result = 0;
	int fd = get_java_var( env, jobj,"fd","I" );
	char message[80];
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_isDTR( JNIEnv *env, jobject jobj )
{
	unsigned int result = 0;
	int fd = get_java_var( env, jobj,"fd","I" );
	char message[80];
...
RXTXPort.setDTR
   ...
   comments:    DTR stands for Data Terminal Ready
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_setDTR( JNIEnv *env, jobject jobj, jboolean state )
{
	unsigned int result = 0;
	int fd = get_java_var( env, jobj,"fd","I" );
	char message[80];
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeSetBaudBase( JNIEnv *env, jobject jobj, jint BaudBase )
{
...
RXTXPort.nativeGetBaudBase
   ...
   comments:
		First introduced in rxtx-2.1-3
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_nativeGetBaudBase( JNIEnv *env, jobject jobj )
{
...
RXTXPort.nativeSetDivisor
   ...
   comments:
		...
		First introduced in rxtx-2.1-3
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeSetDivisor( JNIEnv *env, jobject jobj, jint Divisor )
{
...
RXTXPort.nativeGetDivisor
   ...
   comments:
		First introduced in rxtx-2.1-3
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_nativeGetDivisor( JNIEnv *env, jobject jobj )
{
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeStaticSetDSR (JNIEnv *env, jclass jclazz, jstring jstr, jboolean flag)
{
	int fd;
	int  pid = -1;
	int result;
...
RXTXPort.nativeStaticSetRTS
   ...
   comments:    Set the RTS so it does not raise on the next open
		...
		First introduced in rxtx-1.5-9
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeStaticSetRTS (JNIEnv *env, jclass jclazz, jstring jstr, jboolean flag)
{
	int fd;
	int  pid = -1;
	int result;
...
RXTXPort.nativeStaticSetSerialPortParams
   ...
   comments:    Not set the speed on the next 'open'
		...
		First introduced in rxtx-1.5-9
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_nativeStaticSetSerialPortParams (JNIEnv *env,
...
RXTXPort.nativeStaticSetDTR
   ...
   comments:    Set the DTR so it does not raise on the next open
		...
		First introduced in rxtx-1.5-9
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeStaticSetDTR (JNIEnv *env, jclass jclazz, jstring jstr, jboolean flag)
{
	int fd;
	int  pid = -1;
	const char *filename = (*env)->GetStringUTFChars( env, jstr, 0 );
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeStaticIsRTS( JNIEnv *env, jobject jobj, jstring jstr )
{
	unsigned int result = 0;
	const char *filename = (*env)->GetStringUTFChars( env, jstr, 0 );
...
RXTXPort.nativeStaticIsDSR
   ...
   comments:
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeStaticIsDSR( JNIEnv *env, jobject jobj, jstring jstr )
{
	unsigned int result = 0;
	const char *filename = (*env)->GetStringUTFChars( env, jstr, 0 );
	int fd = find_preopened_ports( filename );
...
RXTXPort.nativeStaticIsDTR
   ...
   comments:    DTR stands for Data Terminal Ready
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeStaticIsDTR ( JNIEnv *env, jobject jobj, jstring jstr )
{
	unsigned int result = 0;
	const char *filename = (*env)->GetStringUTFChars( env, jstr, 0 );
	int fd = find_preopened_ports( filename );
...
RXTXPort.nativeStaticIsCD
   ...
   comments:    CD stands for carrier detect
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeStaticIsCD ( JNIEnv *env, jobject jobj, jstring jstr )
{
	unsigned int result = 0;
	const char *filename = (*env)->GetStringUTFChars( env, jstr, 0 );
	int fd = find_preopened_ports( filename );
...
RXTXPort.nativeStaticIsCTS
   ...
   comments:    CTS stands for Clear To Send
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeStaticIsCTS ( JNIEnv *env, jobject jobj, jstring jstr )
{
	unsigned int result = 0;
	const char *filename = (*env)->GetStringUTFChars( env, jstr, 0 );
	int fd = find_preopened_ports( filename );
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeStaticIsRI ( JNIEnv *env, jobject jobj, jstring jstr )
{
	unsigned int result = 0;
	const char *filename = (*env)->GetStringUTFChars( env, jstr, 0 );
	int fd = find_preopened_ports( filename );
...
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_nativeStaticGetBaudRate( JNIEnv *env, jobject jobj, jstring jstr )
{
	const char *filename = (*env)->GetStringUTFChars( env, jstr, 0 );
	int fd = find_preopened_ports( filename );
	struct termios ttyset;
...
RXTXPort.nativeStaticGetDataBits
   ...
   comments:    simple test for preopened ports
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_nativeStaticGetDataBits( JNIEnv *env, jobject jobj, jstring jstr )
{
	const char *filename = (*env)->GetStringUTFChars( env, jstr, 0 );
	int fd = find_preopened_ports( filename );
	struct termios ttyset;
...
RXTXPort.nativeStaticGetParity
   ...
   comments:    simple test for preopened ports
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_nativeStaticGetParity ( JNIEnv *env, jobject jobj, jstring jstr )
{
	const char *filename = (*env)->GetStringUTFChars( env, jstr, 0 );
	int fd = find_preopened_ports( filename );
	struct termios ttyset;
...
RXTXPort.nativeStaticGetStopBits
   ...
   comments:    simple test for preopened ports
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_nativeStaticGetStopBits ( JNIEnv *env, jobject jobj, jstring jstr )
{
	const char *filename = (*env)->GetStringUTFChars( env, jstr, 0 );
	int fd = find_preopened_ports( filename );
	struct termios ttyset;
...
RXTXPort.nativeGetParityErrorChar
   ...
   comments:    It appears the Parity char is usually \0.  The windows
		...
		solution.
----------------------------------------------------------*/
JNIEXPORT jbyte JNICALL Java_android_gnu_io_RXTXPort_nativeGetParityErrorChar ( JNIEnv *env, jobject jobj )
{
	unsigned int result = 0;
...
RXTXPort.nativeGetEndOfInputChar
   ...
   comments:
----------------------------------------------------------*/
JNIEXPORT jbyte JNICALL Java_android_gnu_io_RXTXPort_nativeGetEndOfInputChar ( JNIEnv *env, jobject jobj )
{
	int fd = get_java_var( env, jobj,"fd","I" );
	struct termios ttyset;
...
RXTXPort.nativeSetParityErrorChar
   ...
   comments:    It appears the Parity char is usually \0.  The windows
		...
		solution.
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeSetParityErrorChar ( JNIEnv *env, jobject jobj, jbyte value )
	{
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeSetEndOfInputChar ( JNIEnv *env, jobject jobj, jbyte value )
{
	int fd = get_java_var( env, jobj,"fd","I" );
	struct termios ttyset;
...
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_NativeEnableReceiveTimeoutThreshold(
...
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_readByte ( JNIEnv *env, jobject jobj )
{
	int bytes;
...
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_readArray ( JNIEnv *env, jobject jobj, jbyteArray jbarray, jint offset, jint length )
{
	int bytes;
	jbyte *body;
	/* char msg[80]; */
...
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXPort_nativeClearCommInput ( JNIEnv *env, jobject jobj )
{
	int fd = get_java_var( env, jobj, "fd", "I" );
...
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_readTerminatedArray( JNIEnv *env,
...
RXTXPort.nativeavailable
   ...
   exceptions:  none
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_nativeavailable( JNIEnv *env, jobject jobj )
{
	int fd = get_java_var( env, jobj,"fd","I" );
	int result;
/*
...
RXTXPort.setflowcontrol
   ...
   comments:  there is no differentiation between input and output hardware
              flow control
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_setflowcontrol ( JNIEnv *env, jobject jobj, jint flowmode )
{
	struct termios ttyset;
	int fd = get_java_var( env, jobj,"fd","I" );
...
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_eventLoop( JNIEnv *env, jobject jobj )
{
#ifdef WIN32
	int i = 0;
#endif /* WIN32 */
...
----------------------------------------------------------*/
JNIEXPORT jstring JNICALL Java_android_gnu_io_RXTXVersion_nativeGetVersion (JNIEnv *env, jclass jclazz )
{
...
JNIEXPORT jboolean  JNICALL Java_android_gnu_io_RXTXCommDriver_testRead(JNIEnv *env, jobject jobj, jstring tty_name, jint port_type)
{
	struct termios ttyset;
	char c;
...
/*----------------------------------------------------------
 registerKnownPorts
   ...
   comments:
----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_android_gnu_io_RXTXCommDriver_registerKnownPorts(JNIEnv *env, jobject jobj, jint portType)
{
...
/*----------------------------------------------------------
 isPortPrefixValid
   ...
   comments:
----------------------------------------------------------*/
JNIEXPORT jboolean  JNICALL Java_android_gnu_io_RXTXCommDriver_isPortPrefixValid (JNIEnv *env, jobject jobj, jstring tty_name)
{
	jboolean result;
	...
	for(i=0;i<64;i++){
		...
		if( i > 25 ) break;
		snprintf(teststring, sizeof(message) ,"%s%s%c",DEVICEDIR, name, i + 97 );
...
----------------------------------------------------------*/
JNIEXPORT jstring JNICALL Java_android_gnu_io_RXTXCommDriver_getDeviceDirectory(JNIEnv *env, jobject obj)
{
...
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_setInputBufferSize(JNIEnv *env, jobject jobj,  jint size )
{
...
/*----------------------------------------------------------
 getIputBufferSize
   ...
   comments:    see fopen/fclose/fwrite/fread man pages.
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_getInputBufferSize(JNIEnv *env, jobject jobj)
{
...
/*----------------------------------------------------------
 setOutputBufferSize
   ...
   comments:    see fopen/fclose/fwrite/fread man pages.
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_setOutputBufferSize(JNIEnv *env, jobject jobj, jint size )
{
...
/*----------------------------------------------------------
 getOutputBufferSize
   ...
   comments:    see fopen/fclose/fwrite/fread man pages.
----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_android_gnu_io_RXTXPort_getOutputBufferSize(JNIEnv *env, jobject jobj)
{
...
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_interruptEventLoop(JNIEnv *env, jobject jobj)
{
	struct event_info_struct *index = master_index;
	int fd = get_java_var( env, jobj, "fd", "I" );
	int searching = 1;
...
----------------------------------------------------------*/
JNIEXPORT void JNICALL Java_android_gnu_io_RXTXPort_nativeSetEventFlag( JNIEnv *env, jobject jobj, jint fd, jint event, jboolean flag )
{
	struct event_info_struct *index = master_index;
...
int fhs_lock( const char *filename, int pid )
{
	...
	*/
	...
	snprintf( lockinfo, sizeof(lockinfo), "%10d\n",(int) getpid() );
