...
------------------------------------------------------------------------------*/
	...
	static
	{
		...
		try
		{
			CommDriver RXTXDriver = (CommDriver) Class.forName("android.gnu.io.RXTXCommDriver").newInstance();
			RXTXDriver.initialize();
		}
		catch (Throwable e)
		{
			System.err.println(e + " thrown while loading " + "android.gnu.io.RXTXCommDriver");
		}
...
------------------------------------------------------------------------------*/
	...
	public CommPort open(String TheOwner, int i)
		throws android.gnu.io.PortInUseException
	{
		...
		if (!isAvailable)
		{
			throw new android.gnu.io.PortInUseException(getCurrentOwner());
		}
		...
		try {
			...
			{
				throw new android.gnu.io.PortInUseException(
