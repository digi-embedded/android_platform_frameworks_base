...
interface IGPUManager
{
    ...
    Bundle getMultiplier();

    // Configures the GPU multiplier.
    Bundle setMultiplier(int multiplier);

    // Returns the minimum GPU multiplier.
    Bundle getMinMultiplier();

    // Configures the minimum GPU multiplier.
    Bundle setMinMultiplier(int multiplier);
}
