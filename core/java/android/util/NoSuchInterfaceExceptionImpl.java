 ...
 * @hide
 */
public class NoSuchInterfaceExceptionImpl extends Exception {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a {@code NoSuchInterfaceExceptionImpl} with the given error
     * message.
     *
     * @param str Error message for the exception.
     */
    public NoSuchInterfaceExceptionImpl(String str) {
        super(str);
    }

    /**
     * Constructs a {@code NoSuchInterfaceExceptionImpl}.
     */
    public NoSuchInterfaceExceptionImpl() {
        super();
    }
}
